...
class ConfigManager {
    ...
    loadConfig() {
        this.config = {
            ...
            filesystem: {
                ...
                allowedExtensions: this.parseArray(process.env.ALLOWED_EXTENSIONS, ['.js', '.ts', '.json', '.txt', '.md']),
    ...
    generateFallbackSecret() {
        ...
        console.warn('⚠️  Using generated JWT secret for development. Set JWT_SECRET environment variable for production.');
        return secret;
    }
