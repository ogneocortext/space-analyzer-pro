...
impl SpaceAnalyzerApp {
    ...
    pub fn process_scheduled_workflows(&mut self) {
        use chrono::Local;
        use space_analyzer_pro_desktop::workflows::matches_cron;
...
async fn generate_ai_recommendations_async(
    ...
    let user_prompt = format!(
        ...
        result.path, result.total_files, space_analyzer_pro_desktop::gui_common::formatting::format_bytes(result.total_size_bytes),
