...
const ChatIllustration: React.FC<{ className?: string }> = ({ className }) => (
    <svg viewBox="0 0 200 120" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Connecting lines */}
        <path d="M75 60 L115 40" stroke="currentColor" strokeWidth="2" opacity="0.4" strokeDasharray="5,5"/>
    </svg>
);
    ...
    const getEmptyStateConfig = (pageType: string) => {
        const configs = {
            dashboard: {
                ...
                description: "Get started by analyzing your file system to unlock powerful insights, AI-powered recommendations, and comprehensive storage analytics.",
                features: [
            ...
            'ai-features': {
                ...
                description: "Our advanced AI algorithms will analyze your files and provide intelligent recommendations for optimization, duplicate detection, and predictive insights.",
                features: [
            ...
            neural: {
                ...
                description: "See your file system as a neural network. Understand relationships, dependencies, and hierarchies through an interactive visualization.",
                features: [
            ...
            chat: {
                ...
                description: "Ask questions about your files in natural language and get instant, intelligent answers.",
                features: [
            ...
            visualization: {
                ...
                description: "Explore your disk usage through an intuitive treemap. See at a glance which files and folders consume the most space.",
                features: [
            ...
            predictive: {
                ...
                description: "Forecast future storage needs and get proactive recommendations before you run out of space.",
                features: [
            ...
            treemap: {
                ...
                description: "Explore your file system through interactive treemaps that show size relationships and directory structures at a glance.",
                features: [
            ...
            'file-browser': {
                ...
                description: "Navigate and explore your file system with powerful search, filtering, and organization capabilities designed for large datasets.",
                features: [
            ...
            analysis: {
                ...
                description: "Comprehensive analysis of your file system with detailed reports and actionable insights.",
                features: [
            ...
            duplicates: {
                ...
                description: "Identify duplicate files across your system and reclaim valuable storage space with smart duplicate detection.",
                features: [
            ...
            optimization: {
                ...
                description: "Get AI-powered recommendations to optimize your file storage and improve system performance.",
                features: [
            ...
            automation: {
                ...
                description: "Set up intelligent automation rules for file organization, cleanup, backup, and maintenance tasks that run automatically.",
                features: [
            ...
            export: {
                ...
                description: "Export your analysis results, visualizations, and reports in multiple formats for sharing, archiving, or further analysis.",
                features: [
            ...
            monitoring: {
                ...
                description: "Monitor your file system health, track changes, and receive alerts about important events and storage conditions.",
                features: [
            ...
            security: {
                ...
                description: "Scan for security vulnerabilities, identify potentially harmful files, and receive recommendations for improving file system security.",
                features: [
            ...
            development: {
                ...
                description: "Access developer tools, APIs, debugging utilities, and advanced configuration options for power users and integrators.",
                features: [
                    "RESTful API access",
            ...
            integrations: {
                ...
                description: "Connect with external services, cloud storage, backup systems, and other tools to extend your file analysis capabilities.",
                features: [
            ...
            settings: {
                ...
                description: "Customize your Space Analyzer Pro experience with themes, preferences, notifications, and advanced configuration options.",
                features: [
