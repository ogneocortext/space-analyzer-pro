      ...
      <div class="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div class="space-y-8 lg:space-y-12 text-center lg:text-left animate-in fade-in slide-in-from-left-12 duration-600">
          <div class="flex justify-center lg:justify-start animate-in zoom-in duration-500 delay-200">
            <div class="relative">
              <div class="absolute inset-0 bg-gradient-to-r from-[#00B4D8] to-purple-500 blur-2xl opacity-20 rounded-full"></div>
              <div class="relative bg-slate-800/50 p-4 lg:p-6 rounded-full border border-white/20 shadow-lg">
                <BrainCircuit :size="80" class="text-transparent bg-gradient-to-r from-[#00B4D8] to-purple-500 bg-clip-text w-12 h-12 lg:w-20 lg:h-20" />
              </div>
            </div>
          </div>

          <h1 class="text-4xl lg:text-5xl text-transparent bg-gradient-to-r from-[#00B4D8] to-purple-500 bg-clip-text leading-tight animate-in fade-in slide-in-from-bottom-5 duration-500 delay-300">
            Space Analyzer Pro
          </h1>
          ...
          <div class="grid grid-cols-2 gap-3 lg:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500">
            <div
              ...
              :key="feature.text"
              class="bg-slate-800/50 backdrop-blur border-2 border-white/20 rounded-xl p-4 cursor-pointer hover:border-[#00B4D8] transition-colors duration-200 hover:scale-103 transition-transform duration-200"
