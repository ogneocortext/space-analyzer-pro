...
const IntegrationsPage: React.FC<IntegrationsPageProps> = ({ analysisData, isLoading }) => {
  ...
  const connectIntegration = (id: string) => {
    setIntegrations(integrations.map(integration => 
      integration.id === id ? { ...integration, status: 'connected' as const, lastSync: new Date() } : integration
    ));
  };
          ...
          <div className={styles.overviewGrid}>
            ...
            <div className={styles.overviewCard}>
              ...
              <div className={styles.overviewValue}>
                {integrations.reduce((latest, integration) => 
                  integration.lastSync && (!latest || integration.lastSync > latest) ? integration.lastSync : latest, null as Date | null
            ...
            {integrations.map((integration) => (
              ...
              >
                <div className={styles.integrationHeader}>
                  <span className={styles.integrationIcon}>{getIntegrationIcon(integration.category)}</span>
                ...
                <div className={styles.configItems}>
                  ...
                  {selectedIntegration.lastSync && (
                    <div className={styles.configItem}>
                      ...
                      <span className={styles.configValue}>{selectedIntegration.lastSync.toLocaleString()}</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className={styles.integrationStats}>
          ...
          <div className={styles.statsGrid}>
            <div className={styles.statCard}>
              <h4>Data Synced</h4>
              <div className={styles.statValue}>{Math.round(analysisData.totalSize / (1024 * 1024 * 1024))} GB</div>
