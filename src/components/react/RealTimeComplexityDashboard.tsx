...
}> = ({ data, thresholds = {}, refreshInterval = 30000, onFileSelect }) => {
      ...
      <div className="dashboard-grid">
        ...
        <div className="overview-section">
          ...
          <div className="metric-card">
            ...
            <div className="metric-value">
              {(
                complexityHotspots.reduce((sum, h) => sum + h.currentComplexity, 0) /
        ...
        <div className="hotspots-section">
          ...
          {filteredHotspots.length > 10 && (
            <div className="show-more">Showing 10 of {filteredHotspots.length} hotspots</div>
          )}
        </div>
