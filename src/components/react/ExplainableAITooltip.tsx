...
export const ExplainableAITooltip: FC<ExplainableAITooltipProps> = ({
  ...
  return (
    <div className="relative inline-block">
      ...
      {isOpen && (
        <div
          className={`absolute z-50 ${getPositionClasses()} w-80 p-4 rounded-xl border backdrop-blur-md shadow-2xl text-sm bg-slate-900/95 border-white/20`}
        >
          {/* Header */}
          <div className="flex items-center justify-between mb-3">
            ...
            <div
              className={`px-2 py-1 rounded-full text-xs font-medium border ${getConfidenceColor(reasoning.confidence)}`}
            >
