      ...
      content: (
        <div className={styles.welcomeContent}>
          ...
          <div className={styles.welcomeText}>
            ...
            <p>
              Space Analyzer Pro combines advanced algorithms with artificial intelligence to give
              you unprecedented insights into your file system.
            </p>
      ...
      content: (
        <div className={styles.stepContent}>
          ...
          <div className={styles.stepText}>
            ...
            <p>
              Click the "Start Analysis" button to begin scanning your files. Our AI will analyze
              your entire file system and provide detailed insights.
            </p>
      ...
      content: (
        <div className={styles.navigationGuide}>
          <div className={styles.navSection}>
            ...
            <p>
              Features are grouped into logical sections: Core Features, AI-Powered tools,
              Visualization, Tools, System, and Configuration.
            </p>
      ...
      content: (
        <div className={styles.completionContent}>
          ...
          <div className={styles.completionText}>
            ...
            <p>
              You've completed the onboarding tour. Start analyzing your files to unlock powerful
            ...
            <div className={styles.dontShowAgain}>
              <label className={styles.checkboxLabel}>
                ...
                />
                <span className={styles.checkboxText}>Don't show this onboarding again</span>
              </label>
    ...
    <div className={styles.overlay}>
      <div className={styles.wizard}>
        ...
        <div className={styles.header}>
          ...
          <button className={styles.closeButton} onClick={handleSkip} aria-label="Skip onboarding">
            <X size={20} />
          </button>
        </div>
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.footerRight}>
            ...
            {currentStepData.action && (
              <button className={styles.actionButton} onClick={currentStepData.action.onClick}>
