...
const EnhancedModelBrowser: React.FC<EnhancedModelBrowserProps> = ({ models, onModelAction }) => {
  ...
  const { gpuMemoryStats, memoryEfficiencyScore, optimizationSuggestions, getMemoryUsageForModel } =
          ...
          <div className="advanced-filters">
            ...
            <div className="filter-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setFilters((prev) => ({ ...prev, minAccuracy: Number(e.target.value) }))
                }
              />
      ...
      <div className="gpu-memory-summary">
        ...
        {optimizationSuggestions.length > 0 && (
          <div className="optimization-suggestions">
            <h5>
              <AlertTriangle size={14} /> Optimization Suggestions
            </h5>
            <ul>
