...
import { BarChart3, Download, RefreshCw, Eye, Code, Layers, TrendingUp, CheckCircle, AlertTriangle } from 'lucide-react';
...
const AnalysisResults: React.FC<AnalysisResultsProps> = memo(({
  ...
  const mockResults = [
    {
      ...
      success: true,
      analysis: 'Implemented responsive design improvements with better accessibility features and enhanced user interactions.',
    ...
    },
    {
      ...
      success: true,
      analysis: 'Optimized neural physics calculations with Web Workers, achieving 60fps animations and reduced memory usage.',
      timestamp: '2026-01-19T02:03:58.114Z',
      responseTime: 15678
    },
    {
      ...
      success: true,
      analysis: 'Successfully integrated drag-and-drop functionality for file analysis with natural language processing capabilities.',
      timestamp: '2026-01-19T02:03:58.114Z',
      responseTime: 8934
    },
    {
      ...
      success: true,
      analysis: 'Code quality improvements implemented with proper error handling and performance monitoring. TypeScript strict mode enabled for better type safety.',
      timestamp: '2026-01-19T02:03:58.114Z',
      responseTime: 47793
    }
  ];
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case 'vision': return 'text-blue-600 bg-blue-50';
      case 'code': return 'text-green-600 bg-green-50';
      case 'combined': return 'text-purple-600 bg-purple-50';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">
              {filteredResults.length > 0 ? Math.round(filteredResults.reduce((acc, r) => acc + r.responseTime, 0) / filteredResults.length / 1000) : 0}s
            </div>
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{result.role} • {result.model}</p>
                  </div>
                </div>
