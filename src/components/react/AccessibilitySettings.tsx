  ...
  const settingsCategories = [
    {
      ...
      settings: [
        ...
        { key: 'visualIndicators' as keyof typeof settings, label: 'Visual Indicators', icon: Monitor }
      ]
    },
    {
      title: 'Interaction',
      ...
      settings: [
        ...
        { key: 'keyboardNavigation' as keyof typeof settings, label: 'Keyboard Navigation', icon: Keyboard },
    ...
    },
    {
      ...
      icon: Volume2,
      settings: [
        { key: 'screenReader' as keyof typeof settings, label: 'Screen Reader Mode', icon: Volume2 },
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-400">
                          {setting.key === 'highContrast' && 'Increase contrast for better visibility'}
                    ...
                    >
                      ...
                      />
                      {isEnabled && (
                        <Check className="absolute top-1 right-1 w-2 h-2 text-white" />
                      )}
                    </button>
                  </div>
                );
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300 mb-2">
              These settings help customize Space Analyzer for different accessibility needs. Changes are saved automatically and will persist across sessions.
            </p>
            <div className="text-xs text-slate-400">
