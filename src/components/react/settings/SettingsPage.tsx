                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => updateSetting('excludeFileTypes', e.target.value.split(',').map(s => s.trim()))}
                                            className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                    ...
                                    {settings.notificationsEnabled && (
                                        <>
                                            <div className="flex items-center justify-between p-4 bg-slate-700 rounded-lg">
                                                ...
                                                <button
                                                    onClick={() => updateSetting('analysisCompleteAlerts', !settings.analysisCompleteAlerts)}
                                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-slate-700 rounded-lg">
                                                ...
                                                <button
                                                    onClick={() => updateSetting('lowDiskSpaceWarnings', !settings.lowDiskSpaceWarnings)}
                                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-slate-700 rounded-lg">
                                                ...
                                                <button
                                                    onClick={() => updateSetting('duplicateFoundNotifications', !settings.duplicateFoundNotifications)}
                                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                                ...
                                                >
                                                    <span
                                                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                                                            settings.duplicateFoundNotifications ? 'translate-x-6' : 'translate-x-1'
                                                        }`}
                                                    />
                                                </button>
                                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button
                                            onClick={() => updateSetting('backgroundAnalysis', !settings.backgroundAnalysis)}
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-400">Automatically export analysis results</p>
                                        </div>
                                        <button
                                            onClick={() => updateSetting('autoExportEnabled', !settings.autoExportEnabled)}
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
