...
export const AppSidebar: FC<AppSidebarProps> = ({
  ...
  return (
    <div
      data-testid="sidebar"
      className={`bg-slate-800 border-r border-slate-700 flex flex-col ${isSidebarOpen ? "w-64" : "w-20"} transition-all duration-300`}
    >
      {/* Logo Section */}
      <div className="flex items-center gap-3 p-4 border-b border-slate-700">
        <div className="w-8 h-8 bg-linear-to-br from-[#00B4D8] to-purple-500 rounded-xl flex items-center justify-center shadow-lg">
      ...
      {/* Navigation */}
      <nav data-testid="navigation" className="flex flex-col gap-1 px-4">
      ...
      <div className="mt-auto p-4 border-t border-slate-700">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className={`flex items-center gap-2`}>
            <div
              className={`w-2 h-2 rounded-full ${isBackendOnline ? "bg-emerald-400" : "bg-orange-400"} animate-pulse`}
            ></div>
