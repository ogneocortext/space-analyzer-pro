...
export const LandingPage: FC<LandingPageProps> = memo(({
    ...
    return (
        <div data-testid="landing-page" className="flex flex-col min-h-screen bg-slate-900 text-white relative overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative z-10">
                <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            <div className="relative">
                                ...
                                <div data-testid="app-logo" className="relative bg-slate-800/50 p-4 lg:p-6 rounded-full border border-white/20 shadow-lg">
                                    <BrainCircuit size={80} className="text-transparent bg-gradient-to-r from-[#00B4D8] to-purple-500 bg-clip-text w-12 h-12 lg:w-20 lg:h-20" />
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            {[
                                ...
                                <motion.div
                                    ...
                                    transition={{ delay: 0.6 + index * 0.05, duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}
                    ...
                    >
                        <div className={`bg-slate-800/50 p-4 lg:p-6 space-y-3 lg:space-y-4 backdrop-blur-lg border border-white/20 rounded-xl ${isDragOver ? 'border-2 border-dashed border-[#00B4D8] bg-[#00B4D8]/10' : ''}`}>
                            <div data-testid="directory-input-section">
                                <label htmlFor="directory-path" className="block text-sm font-medium text-slate-300 mb-2">Target Directory</label>
                                <div className="relative">
                                    <Folder className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-400" size={20} />
                                    <input
                                        ...
                                        type="text"
                                        value={path}
                                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => onPathChange(e.target.value)}
                                    ...
                                    <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
                                        <button
                                            ...
                                            title="Copy path"
                                        >
                                            {copied ? <Check size={16} className="text-[#00B4D8]" /> : <Copy size={16} className="text-slate-300" />}
                                        </button>
                            ...
                            <div data-testid="backend-status" className="flex items-center justify-between text-xs">
                                <div className="flex items-center gap-2">
                                    <div className={`w-2 h-2 rounded-full ${isBackendOnline ? 'bg-[#00B4D8] animate-pulse' : 'bg-red-400'}`} />
                                    <span className={isBackendOnline ? 'text-[#00B4D8]' : 'text-red-400'}>
                                        {isBackendOnline ? 'Backend Online' : 'Backend Offline'}
                                    </span>
                                </div>
                                {!isBackendOnline && (
                                    <span className="text-slate-500">Start the backend server to enable analysis</span>
                                )}
                            </div>
                            ...
                            {analysisData && (
                                ...
                                >
                                    ...
                                    <div data-testid="statistics" className="grid grid-cols-2 gap-3">
                                        <div data-testid="file-count" className="bg-slate-800/50 rounded-lg p-3 text-center">
                                            <div className="text-2xl font-bold text-white mb-1">
                                                {analysisData.files?.length || 0}
                                            </div>
                                            <div className="text-xs text-slate-300">Files</div>
                                        </div>
                                        <div data-testid="total-size" className="bg-slate-800/50 rounded-lg p-3 text-center">
                                            <div className="text-2xl font-bold text-white mb-1">
                                    ...
                                    <div data-testid="visualization" className="mt-4 bg-slate-800/50 rounded-lg p-4">
