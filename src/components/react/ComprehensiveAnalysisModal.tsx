...
const ANALYZERS = [
  { id: 'dependency', name: 'Dependencies', icon: Package, description: 'Inter-file dependencies and circular dependency detection' },
  { id: 'quality', name: 'Code Quality', icon: Code, description: 'Technical debt markers and code smells' },
  { id: 'security', name: 'Security', icon: Shield, description: 'Security vulnerabilities and risk assessment' },
  { id: 'performance', name: 'Performance', icon: Zap, description: 'Performance bottlenecks and optimization opportunities' },
  { id: 'config', name: 'Configuration', icon: Settings, description: 'Config patterns and environment analysis' },
  { id: 'build', name: 'Build & Deploy', icon: Hammer, description: 'Build and deployment configuration analysis' },
  { id: 'docs', name: 'Documentation', icon: FileText, description: 'Documentation coverage and quality metrics' },
  { id: 'test', name: 'Testing', icon: TestTube, description: 'Test coverage and organization patterns' },
  { id: 'version', name: 'Version Analysis', icon: Package, description: 'Dependency versions and outdated package detection' },
  { id: 'org', name: 'Organization', icon: Users, description: 'Code organization patterns and architecture compliance' },
  { id: 'dev', name: 'Developer Activity', icon: GitBranch, description: 'Developer activity patterns and ownership information' },
  { id: 'license', name: 'License Analysis', icon: Scale, description: 'License detection and compliance analysis' }
];
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Configure and run deep analysis with specialized analyzers</p>
            </div>
          </div>
          <button
            onClick={onClose}
