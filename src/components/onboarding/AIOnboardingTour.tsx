  ...
  const tourSteps: TourStep[] = [
    {
      ...
      title: 'AI Assistant',
      content: 'Ask questions about your files using natural language. Get insights, recommendations, and help with file management.',
      position: 'bottom',
      action: () => {
    ...
    },
    {
      ...
      content: 'Explore file relationships through an interactive neural network. Discover patterns and connections in your data.',
      position: 'left',
      action: () => {
    ...
    },
    {
      ...
      content: 'Get AI-powered insights about your storage usage, duplicate files, and optimization opportunities.',
      position: 'top',
      action: () => {
    ...
    },
    {
      ...
      content: 'Press Ctrl+K to quickly access any feature. Search, navigate, and execute commands instantly.',
      position: 'bottom',
      action: () => {
    ...
    },
    {
      ...
      content: 'Compare file system snapshots over time. Track changes and analyze storage evolution.',
      position: 'right',
      action: () => {
