...
export const RealDependencies: React.FC<{ analysisData: AnalysisResult }> = ({ analysisData }) => {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'directory': return <Folder size={16} className="text-yellow-400" />;
  ...
  const getEdgeTypeColor = (type: string) => {
    switch (type) {
      case 'import': return 'text-cyan-400';
      case 'require': return 'text-purple-400';
      case 'extends': return 'text-green-400';
      case 'call': return 'text-orange-400';
    ...
    <div className="p-8 text-white">
      <div className="mb-8">
        ...
        <p className="text-slate-400 text-lg">
          Module analysis and dependency graph visualization
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-cyan-400 mb-2">{dependencyAnalysis.totalNodes}</div>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-purple-400 mb-2">{dependencyAnalysis.totalEdges}</div>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-orange-400 mb-2">{dependencyAnalysis.circularDependencies.length}</div>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-green-400 mb-2">{dependencyAnalysis.isolatedNodes.length}</div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                viewMode === 'graph' ? 'bg-cyan-500/20 text-cyan-400' : 'bg-slate-700 text-slate-300 hover:bg-slate-600'
              }`}
            >
              <Network size={16} />
              Graph
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                viewMode === 'list' ? 'bg-cyan-500/20 text-cyan-400' : 'bg-slate-700 text-slate-300 hover:bg-slate-600'
              }`}
            >
              <FileText size={16} />
              List
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                viewMode === 'tree' ? 'bg-cyan-500/20 text-cyan-400' : 'bg-slate-700 text-slate-300 hover:bg-slate-600'
              }`}
            >
              <GitBranch size={16} />
              Tree
        ...
        <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-2">
            {dependencyAnalysis.circularDependencies.map((dep, index) => {
              ...
              return (
                <div key={index} className="p-3 bg-orange-500/10 rounded-lg flex items-center gap-2">
