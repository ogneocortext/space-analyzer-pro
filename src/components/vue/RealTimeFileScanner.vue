...
watch(() => props.progress.currentFile, (newFile) => {
  if (newFile && newFile !== 'Analysis complete' && newFile !== 'Analysis failed' && !newFile.startsWith('Scanned')) {
...
watch(() => props.progress.files, (newFiles, oldFiles) => {
