<template>
  <div class="relative inline-block">
    <div @mouseenter="isOpen = true" @mouseleave="isOpen = false" class="cursor-help">
      <slot />
    </div>
    ...
    <Transition name="fade">
      <div
        ...
        :class="[
          'absolute z-50',
          getPositionClasses(),
          'w-80 p-4 rounded-xl border backdrop-blur-md shadow-2xl text-sm bg-slate-900/95 border-white/20',
        ]"
      >
        <!-- Header -->
        <div class="flex items-center justify-between mb-3">
          ...
          <div
            :class="[
              ...
              getConfidenceColor(reasoning.confidence),
            ]"
          >
            ...
            >
              <div class="flex items-center space-x-2 flex-1 min-w-0">
                <component
                  ...
                  :size="12"
                  :class="getFactorColor(factor.type)"
                />
        ...
        <div v-if="reasoning.evidence && reasoning.evidence.length > 0" class="mb-4">
          <h5 class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Evidence</h5>
          <ul class="space-y-1">
            <li
