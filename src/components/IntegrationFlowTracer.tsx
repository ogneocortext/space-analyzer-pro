...
export const IntegrationFlowTracer: FC<IntegrationFlowTracerProps> = ({
  ...
  const [filterType, setFilterType] = useState<'all' | 'connected' | 'missing' | 'high-confidence'>('all');
  ...
  useEffect(() => {
    const loadIntegrationData = async () => {
      ...
      try {
        ...
        const mediumConfidence = connectionFlows.filter(c => c.confidence >= 0.5 && c.confidence < 0.8).length;
  ...
  const generateFlowPath = (component: ComponentConnection, endpoint: EndpointConnection): FlowStep[] => {
    const path: FlowStep[] = [
      {
                  ...
                  <div className="connection-info">
                    <div className="component-info">
                      ...
                      <div className="component-type">
                        {connection.frontendComponent.type}
                      </div>
                    ...
                    <div className="endpoint-info">
                      ...
                      <div className="endpoint-method">
                        {connection.backendEndpoint.method}
                      </div>
            ...
            {filteredConnections.length === 0 && (
              <div className="empty-state">
                ...
                <p className="empty-description">
                  Try adjusting filters or check if frontend components are properly connected to backend endpoints.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="connections-section">
          ...
          <div className="connections-list">
            {filteredMissingConnections.map((connection, index) => (
              <div
                key={index}
                className="connection-item missing-connection"
              >
                <div className="connection-header">
                  <div className="component-info">
                    <div className="component-name">
