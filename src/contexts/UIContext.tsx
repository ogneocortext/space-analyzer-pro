...
type UIAction =
  ...
  | { type: 'ADD_NOTIFICATION'; payload: Omit<UIState['notifications'][0], 'id' | 'timestamp' | 'read'> }
...
export const UIProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const actions = {
    ...
    addNotification: (notification: Omit<UIState['notifications'][0], 'id' | 'timestamp' | 'read'>) => {
