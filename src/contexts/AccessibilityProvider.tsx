...
import { Eye, EyeOff, Volume2, VolumeX, Keyboard, Monitor, Palette, Contrast, Type } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className={`px-2 py-1 rounded text-xs ${
                  settings.keyboardNavigation ? 'bg-green-600 text-white' : 'bg-gray-600 text-gray-300'
                }`}>
