...
export type ViewType = 'analysis' | 'ai-insights' | 'visualization' | 'recommendations' | 'security' | 'duplicates' | 'treemap' | 'timeline' | 'learning' | 'development' | 'export' | 'system' | 'neural' | 'chat';
