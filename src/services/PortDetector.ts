...
export class PortDetector {
    ...
    public async detectAllServers(): Promise<PortConfiguration> {
        console.log('🔍 Starting comprehensive server detection...');
        ...
        if (frontendResult) {
            ...
            console.log(`✅ Frontend server detected on port ${frontendResult.port}`);
        } else {
            console.log('⚠️ No frontend server detected, using default port 5176');
        }
        ...
        if (backendResult) {
            ...
            console.log(`✅ Backend server detected on port ${backendResult.port}`);
        } else {
            console.log('⚠️ No backend server detected, using default port 8081');
        }
        ...
        console.log(`🎯 Server detection completed in ${detectionTime}ms`);
        console.log(`📊 Configuration: Frontend=${this.config.frontend}, Backend=${this.config.backend}, API=${this.config.api}`);
    ...
    public async refreshDetection(): Promise<PortConfiguration> {
        console.log('🔄 Forcing server detection refresh...');
    ...
    public clearCache(): void {
        this.serverCache.clear();
        console.log('🧹 Port detection cache cleared');
    }
