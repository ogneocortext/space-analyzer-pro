...
export class OptimizationEngine {
  ...
  generateOptimizationSuggestions(graph: DependencyGraph): OptimizationSuggestion[] {
    ...
    suggestions.sort((a, b) => {
      const impactA =
        a.impact.complexityReduction + a.impact.maintainabilityImprovement + a.impact.sizeReduction;
      const impactB =
        b.impact.complexityReduction + b.impact.maintainabilityImprovement + b.impact.sizeReduction;
      return impactB - impactA;
    });

    console.warn(`✅ Generated ${suggestions.length} optimization suggestions`);
