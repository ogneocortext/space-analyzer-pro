...
export const analysisStoreKey: InjectionKey<ReturnType<typeof useAnalysisStore>> =
  Symbol("analysisStore");
...
export const handleSelectRecentPathKey: InjectionKey<(path: string) => void> =
  Symbol("handleSelectRecentPath");
...
export const navigateToVisualizationKey: InjectionKey<() => void> =
  Symbol("navigateToVisualization");
...
export const getCategoryColorKey: InjectionKey<(category: string) => string> =
  Symbol("getCategoryColor");
