...
export class ShareManager {
  ...
  public static shareToSocialMedia(
    ...
    const { title = "3D File System Visualization", description = "Interactive 3D visualization" } =
      options;
