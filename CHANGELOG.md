...
| ------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.10.0  | 2026-05-05 | Ollama 0.23.0 Integration + Lucide Icons: Zod validation, rate limiting, 14 localhost tools, secure env config, comprehensive testing, emoji to icon migration |
...
**Full compatibility with Ollama 0.23.0 including structured outputs and extended thinking:**

- **Zod Validation**: Runtime schema validation with `zod-to-json-schema` integration
- **Rate Limiting**: Token bucket algorithm with configurable limits
- **14 Localhost Tools**: Comprehensive tools for system integration
- **Secure Environment**: Separate `.env.ollama` for sensitive configuration

### Lucide Icon Replacement

**Complete migration from emoji icons to Lucide icon library:**
...
- `✓` → `Check`
- `✕` → `X`
- Notification type icons → Dynamic `getNotificationIcon()` mapping
...
- Emoji strings → Icon name strings for Lucide mapping

#### Benefits

- **Consistency**: Uniform icon style across the application
- **Scalability**: Vector icons scale without quality loss
- **Accessibility**: Better screen reader support with `aria-hidden`
- **Maintainability**: Centralized icon library (`lucide-vue-next`)
